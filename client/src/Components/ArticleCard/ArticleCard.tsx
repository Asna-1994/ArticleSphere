...
//     <div
//       key={article._id}
//       className="bg-white dark:bg-gray-900  rounded-2xl shadow-md p-4 transition hover:shadow-xl hover:scale-[1.01] duration-200 ease-in-out"
//     >
...
//       <h2 className="text-lg font-semibold text-gray-800 dark:text-white line-clamp-2">{article.title}</h2>
